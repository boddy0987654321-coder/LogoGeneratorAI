...
<main style="background-color: #0a0b10; min-height: 60vh; padding: 120px 24px 80px; color: #ffffff; font-family: 'DM Sans', sans-serif;">
  <div style="max-width: 800px; margin: 0 auto; text-align: center;">
    <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(124,92,252,0.12); border: 1px solid rgba(124,92,252,0.28); border-radius: 100px; padding: 6px 14px; font-size: 12px; font-weight: 500; color: #7c5cfc; margin-bottom: 24px;">
      <span>💎</span> <?= $current_lang == 'ro' ? 'Performanță Maximă' : 'Maximum Performance' ?>
    </div>
    <h1 style="font-family: 'Syne', sans-serif; font-size: clamp(32px, 4vw, 48px); font-weight: 800; letter-spacing: -1px; margin-bottom: 40px;"><?= t('footer_premium') ?></h1>
    <div style="text-align: left; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 32px; border-radius: 16px; margin-bottom: 40px;">
        <p style="color: #b4bccb; font-size: 16px; line-height: 1.8;">
          <?= $current_lang == 'ro' 
              ? 'Treci la nivelul următor cu planul Premium. Obții acces nelimitat la generarea de logo-uri cu rezoluție ultra-înaltă, descărcări în format vectorial (SVG) ideale pentru print și drepturi comerciale depline asupra fiecărui design creat.' 
              : 'Upgrade to the Premium plan. Gain unlimited access to ultra-high-resolution logo generation, vector downloads (SVG) ideal for printing, and full commercial rights over every design created.' ?>
        </p>
    </div>
